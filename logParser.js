...
const p = '\\[%{DATA:time}\\] %{WORD:winStatus} Побед: %{INT:wins} Поражений: %{INT:looses} WinStreak: %{INT:winStreak} LooseStreak: %{INT:looseStreak} Всего сыграно игр: %{INT:games} Максимальный WinStreak: %{INT:maxWinStreak} Максимальный LooseStreak: %{INT:maxLooseStreak} WinRate: %{WORD:winRate}';
var dataArray = [];
